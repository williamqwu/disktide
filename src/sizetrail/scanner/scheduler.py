...
from sizetrail.domain.live_view import build_live_view
from sizetrail.domain.metrics import MetricId, sum_available
from sizetrail.domain.policy import ScanPolicy
from sizetrail.domain.scan import ScanTreeUpdate
from sizetrail.models.tree import FSNode
from sizetrail.scanner.walker import (
    classify_symlink,
    make_file_node,
    make_symlink_node,
)
...
class TreeScanScheduler:
    ...
    def scan(self, path: str) -> ScheduledTree:
        ...
        executor = ThreadPoolExecutor(
            ...
            thread_name_prefix="sizetrail-scan",
        )
        try:
