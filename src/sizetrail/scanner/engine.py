...
from sizetrail.domain.scan import ScanTreeUpdate, ScanWorkerSelection
from sizetrail.models.tree import FSNode
from sizetrail.scanner.accounting import finalize_unique_allocated
from sizetrail.scanner.policy import discover_pseudo_mounts
from sizetrail.scanner.progress import ProgressThrottle, ScanProgress
from sizetrail.scanner.scheduler import (
...
class ScanEngine:
    ...
    def __init__(
        ...
        from sizetrail.scanner.sysinfo import select_scan_workers
