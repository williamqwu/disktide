...
from sizetrail.domain.monitor import WatchDiagnostics
...
def probe_native_event_backend() -> EventBackendInfo:
    if not sys.platform.startswith("linux"):
        return EventBackendInfo(
            ...
            suggestion="Use periodic mode; Linux inotify support is available through sizetrail[watch].",
            system=sys.platform,
        )
