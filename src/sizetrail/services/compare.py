...
from sizetrail.domain.delta import (
    CompareResult,
...
from sizetrail.domain.snapshot import SNAPSHOT_FORMAT_VERSION, Snapshot
...
def assess_compatibility(
    ...
    if baseline.legacy or target.legacy:
        add(
            ...
            f"take two new snapshots with sizetrail {__version__} or use --raw",
        )
    if (
        ...
        add(
            ...
            "upgrade sizetrail before comparing these snapshots",
        )
    if (
        ...
        add(
            ...
            "rescan both points with the same sizetrail release family",
        )
