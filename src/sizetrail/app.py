...
from sizetrail import APP_NAME
from sizetrail.cleanup.actions import QuarantineExecutor
from sizetrail.cleanup.rules import get_rule_by_name
...
from sizetrail.viz.colors import set_color_scheme
...
from sizetrail.screens.settings import SettingsScreen
from sizetrail.screens.fs_overview import FSOverviewScreen
from sizetrail.widgets.confirm_modal import ConfirmModal
from sizetrail.widgets.monitor_editor import MonitorEditor, MonitorEditorResult


class SizeTrailApp(App):
    ...
    def on_mount(self) -> None:
        ...
        if self._show_welcome:
            from sizetrail.screens.welcome import WelcomeScreen
