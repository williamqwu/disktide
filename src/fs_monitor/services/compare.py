...
from fs_monitor.domain.snapshot import SNAPSHOT_FORMAT_VERSION, Snapshot
...
def assess_compatibility(
    ...
    if (
        ...
        add(
            ...
            "upgrade fsmonitor before comparing these snapshots",
        )
    if (
        ...
        add(
            ...
            "rescan both points with the same fsmonitor release family",
        )
