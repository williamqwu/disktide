...
**A key map that exists, a command palette that was switched off, a footer that fits the terminal it is drawn in, and nine keys that stopped meaning two things**
